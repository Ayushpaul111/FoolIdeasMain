...
const Team = () => {
  const items=[{name:"Bireswar Das",image:"/team_images/biru.png", role:"Marketing Lead Fool Ideas"},{name:"Md Imon Hossen",image:"/team_images/MDImonHossen.png", role:"Graphic Designer"},{name:"Sudip Adhikary",image:"/team_images/SudipAdhikary.jpg", role:"Photographer"},{name:"Mrinmoy Sarkar",image:"/team_images/MrinmoySarkar.jpg", role:"Video Editor"}]
  return (
    <div className=" mb-32 ">
