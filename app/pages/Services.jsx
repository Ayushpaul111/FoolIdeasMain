    ...
    <section>
      <div className="text-center mx-3 mb-32">
        ...
        <div className="flex justify-center mt-8 flex-wrap">
          <div  className="relative w-[400px] h-[420px] mx-3 my-3  border-[1px] border-[#007443A3] rounded-lg bg-gradient-to-tr from-0% from-[#79f7b631] to-[#001C10] to-90% bg-opacity-30">
          <div className="absolute h-[100%] w-[100%] bg-[url('/services/union.png')]">

          </div>
            <div className="m-5 relative h-[90%] ">
              <div className="w-[100px] h-[100px] "><Image src="/services/social.svg" height={100} width={100}/></div>
          ...
          <div className="w-[400px] h-[420px] mx-3 my-3  border-[1px] border-[#007443A3] rounded-lg bg-gradient-to-tr from-0% from-[#79f7b631] to-[#001C10] to-9  0%">
            <div className="m-5 relative h-[90%] ">
              <div className="w-[100px] h-[100px] "><Image src="/services/social.svg" height={100} width={100}/></div>
